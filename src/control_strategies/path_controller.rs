...
use crate::robot::joint_map::{ArmJointMap, JointVelocities, FINGERS_OPEN};
use crate::robot::{arm_joint_angles, RobotBodyPartIndex};
...
impl ControllerStrategy for PathController {
    fn apply_controller(
        ...
        let target_angles: Vector4<f32> = self
            .motion_plan
            .clamped_sample(self.time)
            .expect("Empty path.");
